...
public class QMovie extends EntityPathBase<Movie> {
    ...
    private static final long serialVersionUID = 892286826L;
    ...
    //inherited
    public final ListPath<com.cruway.springmall.domain.Category, com.cruway.springmall.domain.QCategory> categories = _super.categories;
